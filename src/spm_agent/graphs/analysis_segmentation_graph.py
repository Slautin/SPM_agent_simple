...
from spm_agent.nodes.segmentation_criteria_node import segmentation_criteria_node
...
def build_analysis_graph():
    ...
    img.add_node("criteria_segmentation", segmentation_criteria_node)
    img.add_edge(START, "channel_recommendation")
    img.add_edge("channel_recommendation", "segmentation")  
    img.add_edge("segmentation", "criteria_segmentation")
    img.add_edge("criteria_segmentation", END)
